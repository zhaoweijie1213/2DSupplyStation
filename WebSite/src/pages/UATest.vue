    ...
    <v-card elevation="4" rounded="lg">
      ...
      <v-card-text>
        <v-list dense>
          <v-list-item>
            <v-list-item-content>
              <v-list-item-title class="font-weight-bold">完整 UA：</v-list-item-title>
              <v-list-item-subtitle class="monospace">{{ ua }}</v-list-item-subtitle>
            </v-list-item-content>
            <v-list-item-action>
          ...
          <v-list-item>
            <v-list-item-content>
              <v-list-item-title class="font-weight-bold">检测结果：</v-list-item-title>
              <v-list-item-subtitle>
                <div>是否微信内置浏览器：<strong>{{ isWeChat }}</strong></div>
                <div>是否QQ内置浏览器：<strong>{{ isQQ }}</strong></div>
                <div>是否淘宝内置浏览器：<strong>{{ isTaobao }}</strong></div>
                <div>是否天猫内置浏览器：<strong>{{ isTmall }}</strong></div>
                <div>是否支付宝内置浏览器：<strong>{{ isAlipay }}</strong></div>
              </v-list-item-subtitle>
            </v-list-item-content>
          </v-list-item>
          ...
          <v-list-item>
            <v-list-item-content>
              <v-list-item-title class="font-weight-bold">当前环境：</v-list-item-title>
...
const isTaobao  = computed(() => ua.includes('aliapp(tb/') || ua.includes('aliapp(tm/'))
